<%-- 
    Document   : product_display_tv
    Created on : Jun 3, 2017, 9:26:54 PM
...
<html>
    ...
    <ul>
        ...
        <li style="float: right;"><a href="../client/client_login.jsp?client_path=productdisplaytv&pro_id=<%= pd%>">Login</a></li>
            <%
                }
            %>
    </ul>
    ...
    <div>
        <form action="../ProductPlacement">
            <%
                if (s == null) {
            %>
            <input type="hidden" name="login" value="productdisplaytv" />
            <%
                }
            %>
        ...
        <%
            try {
                ...
                PreparedStatement ps = con.prepareCall("select * from product_tech_detail_tv where product_id=?");
                ps.setString(1, pd);
        ...
        <div>
            <table>
                ...
                <tr>
                    ...
                    <td>1 year manufacturer warranty for device from the date of purchase.</td>
                </tr>
            </table>
        </div>
        <%
